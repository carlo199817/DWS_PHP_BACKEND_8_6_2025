...
if ($_SERVER['REQUEST_METHOD'] === "POST") {
        ...
        foreach($form->getFormtask() as $task){
            ...
            array_push($task_list,['id'=>$task->getId(),'title'=>$task->getTitle(),'description'=>$task->getDescription(),'series'=>$task->getSeries(),'validation'=>$validation_list,  "field"=>count($task->getTaskfield()
        )]);
        }
