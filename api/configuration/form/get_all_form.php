...
if ($_SERVER['REQUEST_METHOD'] === "GET") {
        ...
        foreach($forms as $form){
            ...
            array_push($form_list,['id'=>$form->getId(),'title'=>$form->getTitle(),"type"=>$type->getDescription(),"created_by"=>$user->getFirstname() . " " . $user->getLastname(),"date_created"=>$form->getDatecreated()->format('m-d-Y'),'version'=>$form->getVersion(),
        ]);
        }
